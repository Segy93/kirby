...
class optickiuređajiCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_opticki_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_opticki_namena',
                'name_import'       =>  'Namena',
                'label'             =>  'Namena',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_opticki_tip',
                'name_import'       =>  'Tip',
                'label'             =>  'Tip',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_opticki_vrsta_prikljucka',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_opticki_citanje_pisanje',
                'name_import'       =>  'Čitanje / Pisanje',
                'label'             =>  'Čitanje / Pisanje',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
                'order_product'     =>  5,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_opticki_kes_memorija',
                'name_import'       =>  'Keš memorija',
                'label'             =>  'Keš memorija',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
