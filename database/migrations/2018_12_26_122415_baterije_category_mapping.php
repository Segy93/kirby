...
class baterijeCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_lap_baterije_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_baterije_namena',
                'name_import'       =>  'Namena',
                'label'             =>  'Namena',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_baterije_za_modele',
                'name_import'       =>  'Za modele',
                'label'             =>  'Za modele',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_baterije_kapacitet',
                'name_import'       =>  'Kapacitet',
                'label'             =>  'Kapacitet',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
                'order_filter'      =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_baterije_broj_celija',
                'name_import'       =>  'Broj ćelija',
                'label'             =>  'Broj ćelija',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
                'order_filter'      =>  3,
