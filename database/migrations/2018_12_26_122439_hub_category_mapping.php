...
class hubCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_hub_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_hub_broj_usb_prikljucaka',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_hub_usb_standard',
                'name_import'       =>  'USB standard',
                'label'             =>  'USB standard',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
                'order_filter'      =>  3,
