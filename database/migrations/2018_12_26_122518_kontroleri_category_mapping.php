...
class kontroleriCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_kontroleri_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_kontroleri_tip',
                'name_import'       =>  'Tip',
                'label'             =>  'Tip',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_kontroleri_nacin_prikljuce',
                'name_import'       =>  'Način priključenja',
                'label'             =>  'Način priključenja',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
                'order_filter'      =>  3,
                'order_product'     =>  3,
