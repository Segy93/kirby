...
class softwareCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_software_broj_licenci',
                'name_import'       =>  'Broj licenci u paketu',
                'label'             =>  'Broj licenci u paketu',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
                'order_filter'      =>  3,
                'order_product'     =>  3,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_software_duzina_licence',
                'name_import'       =>  'Dužina licence',
                'label'             =>  'Dužina licence',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
                'order_product'     =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_software_podvrsta',
                'name_import'       =>  'Podvrsta',
                'label'             =>  'Podvrsta',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_software_posebni_uslovi_pr',
                'name_import'       =>  'Posebni uslovi prodaje',
                'label'             =>  'Posebni uslovi prodaje',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
                'order_product'     =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_software_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_software_vrsta',
                'name_import'       =>  'Vrsta',
                'label'             =>  'Vrsta',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
