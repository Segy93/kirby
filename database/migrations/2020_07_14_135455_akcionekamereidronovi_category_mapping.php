...
class akcionekamereidronoviCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Categories')->insert(
            [
                'name'          =>  'Akcione kamere I dronovi',
                'name_import'   =>  'A.cam-dron',
            ]
        );
        ...
        $category = DB::table('Categories')
            ->where('name', '=', 'Akcione kamere I dronovi')
            ->first()
        ;
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_akcione_kamere_i_dronovi_proizvodjac',
