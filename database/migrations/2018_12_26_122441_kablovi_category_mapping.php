...
class kabloviCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_kablovi_duzina',
                'name_import'       =>  'Dužina',
                'label'             =>  'Dužina',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_kablovi_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_kablovi_tip_kabla',
                'name_import'       =>  'Tip kabla',
                'label'             =>  'Tip kabla',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
                'order_filter'      =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_kablovi_vrsta',
                'name_import'       =>  'Vrsta',
                'label'             =>  'Vrsta',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
