...
class switchCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_switch_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_switch_vrsta_upravljanja',
                'name_import'       =>  'Upravljanje',
                'label'             =>  'Upravljanje',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
                'order_filter'      =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_switch_broj_portova',
                'name_import'       =>  'Broj portova',
                'label'             =>  'Broj portova',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
                'order_filter'      =>  3,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_switch_brz_prenosa_podatak',
                'name_import'       =>  'Brzina prenosa podataka',
                'label'             =>  'Brzina prenosa podataka',
                'type'              =>  'checkbox',
                'order_category'    =>  4,
                'order_filter'      =>  4,
                'order_product'     =>  4,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_switch_portovi',
                'name_import'       =>  'Portovi',
                'label'             =>  'Portovi',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_switch_napajanje',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_switch_forma',
                'name_import'       =>  'Forma',
                'label'             =>  'Forma',
                'type'              =>  'checkbox',
                'order_category'    =>  5,
