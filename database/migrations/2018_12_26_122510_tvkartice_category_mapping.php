...
class tvkarticeCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_tv_karte_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_tv_karte_tjuner',
                'name_import'       =>  'Vrsta tjunera',
                'label'             =>  'Vrsta tjunera',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
                'order_filter'      =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_tv_karte_interfejs',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_tv_karte_prikljucci',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_tv_kartice_fm_radio',
                'name_import'       =>  'FM radio',
                'label'             =>  'FM radio',
                'type'              =>  'checkbox',
                'order_category'    =>  4,
                'order_filter'      =>  4,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_daljinski',
                'name_import'       =>  'Daljinski',
                'label'             =>  'Daljinski',
                'type'              =>  'checkbox',
                'order_category'    =>  5,
                'order_filter'      =>  5,
