...
class medijiCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_mediji_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_mediji_vrsta',
                'name_import'       =>  'Vrsta',
                'label'             =>  'Vrsta',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_mediji_pakovanje',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_mediji_br_komada_u_pakovan',
                'name_import'       =>  'Broj kom. u pakovanju',
                'label'             =>  'Broj kom. u pakovanju',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
                'order_product'     =>  null,
