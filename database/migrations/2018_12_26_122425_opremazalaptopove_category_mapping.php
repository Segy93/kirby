...
class opremazalaptopoveCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Categories')->insert(
            [
                'name'          =>  'Oprema za laptopove',
                'name_import'   =>  'NB OPREMA',
            ]
        );
        ...
        $category = DB::table('Categories')
            ->where('name', '=', 'Oprema za laptopove')
            ->first()
        ;
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_dodat_oprema_lap_proizvodj',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_dodat_oprema_lap_tip',
                'name_import'       =>  'Tip uređaja',
                'label'             =>  'Tip uređaja',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
                'order_filter'      =>  2,
