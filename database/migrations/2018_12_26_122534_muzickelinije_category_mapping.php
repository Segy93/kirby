...
class muzickelinijeCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_muzicke_linije_podrz_medij',
                'name_import'       =>  'Podržani mediji',
                'label'             =>  'Podržani mediji',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
                'order_product'     =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_muzicke_linije_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_muzicke_linije_radio_tjune',
                'name_import'       =>  'Radio tjuner',
                'label'             =>  'Radio tjuner',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_muzicke_linije_ukupna_snag',
                'name_import'       =>  'Snaga zvučnika',
                'label'             =>  'Snaga zvučnika',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
                'order_product'     =>  null,
