...
class ramCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_ram_ecc_podrska',
                'name_import'       =>  'ECC Podrška',
                'label'             =>  'ECC Podrška',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_ram_hladnjaci',
                'name_import'       =>  'Hladnjaci',
                'label'             =>  'Hladnjaci',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_ram_latencija',
                'name_import'       =>  'Latencija',
                'label'             =>  'Latencija',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_ram_potrosnja',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_ram_paket_za',
                'name_import'       =>  'Paket za',
                'label'             =>  'Paket za',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  6,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_ram_pakovanje',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_ram_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_ram_brzina',
                'name_import'       =>  'Radni takt',
                'label'             =>  'Radni takt',
                'type'              =>  'checkbox',
                'order_category'    =>  4,
                'order_filter'      =>  5,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_tip_memorije',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_ram_voltaza',
                'name_import'       =>  'Voltaža',
                'label'             =>  'Voltaža',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
