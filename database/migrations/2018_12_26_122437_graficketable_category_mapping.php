...
class graficketableCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_graficke_table_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_graficke_table_aktivna_pov',
                'name_import'       =>  'Aktivna površina',
                'label'             =>  'Aktivna površina',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
                'order_filter'      =>  2,
                'order_product'     =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_graficke_table_nac_poveziv',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_graficke_table_sadrzaj_pak',
                'name_import'       =>  'Sadržaj paketa',
