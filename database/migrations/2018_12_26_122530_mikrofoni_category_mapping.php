...
class mikrofoniCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_mikrofoni_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_mikrofoni_prikljucak',
                'name_import'       =>  'Priključak',
                'label'             =>  'Priključak',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
                'order_filter'      =>  2,
