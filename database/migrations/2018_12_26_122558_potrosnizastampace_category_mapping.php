...
class potrosnizastampaceCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        $category = DB::table('Categories')
            ->where('name', '=', 'Potrošni za štampače')
            ->first()
        ;
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_potrosni_stampaci_proizvod',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_potrosni_stampaci_tip',
                'name_import'       =>  'Tip',
                'label'             =>  'Tip',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_potrosni_preporuceno',
                'name_import'       =>  'Preporučeni za štampače',
                'label'             =>  'Preporučeni za štampače',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
                'order_filter'      =>  3,
                'order_product'     =>  3,
