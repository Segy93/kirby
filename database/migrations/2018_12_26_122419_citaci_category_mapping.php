...
class citaciCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_citaci_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_citaci_podrzane_kartice',
                'name_import'       =>  'Podržane kartice',
                'label'             =>  'Podržane kartice',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
                'order_filter'      =>  null,
                'order_product'     =>  3,
