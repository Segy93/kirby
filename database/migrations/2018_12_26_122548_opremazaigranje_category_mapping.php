...
class opremazaigranjeCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_oprema_igranje_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_oprema_igranje_vrsta',
                'name_import'       =>  'Vrsta',
                'label'             =>  'Vrsta',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_oprema_igranje_vrsta_konek',
                'name_import'       =>  'Vrsta konekcije',
                'label'             =>  'Vrsta konekcije',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
                'order_filter'      =>  3,
                'order_product'     =>  3,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_oprema_igranje_vibracija',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_oprema_igranje_br_tastera',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_oprema_igranje_dodatna_opr',
                'name_import'       =>  'Dodatna oprema',
