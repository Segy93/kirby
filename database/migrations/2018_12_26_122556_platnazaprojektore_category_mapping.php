...
class platnazaprojektoreCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        $category = DB::table('Categories')
            ->where('name', '=', 'Platna za projektore')
            ->first()
        ;
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_platna_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_platna_velicina',
                'name_import'       =>  'Veličina platna u cm',
                'label'             =>  'Veličina platna u cm',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
                'order_filter'      =>  3,
                'order_product'     =>  3,
