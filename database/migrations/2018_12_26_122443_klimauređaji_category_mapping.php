...
class klimauređajiCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_klime_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_klime_kapacitet_hladjenja',
                'name_import'       =>  'Kapacitet hlađenja u kW',
                'label'             =>  'Kapacitet hlađenja u kW',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
                'order_product'     =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_klime_kapacitet_grejanja',
                'name_import'       =>  'Kapacitet grejanja u kW',
                'label'             =>  'Kapacitet grejanja u kW',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
                'order_product'     =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_klime_inverter',
                'name_import'       =>  'Inverter',
                'label'             =>  'Inverter',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_klime_energetska_klasa',
                'name_import'       =>  'Energetska klasa',
