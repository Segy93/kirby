...
class harddiskoviCategoryMapping extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up() {
        ...
        DB::table('Attributes')->insert(
            [
                ...
                'machine_name'      =>  'field_hard_diskovi_proizvodjac',
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_hard_diskovi_namena',
                'name_import'       =>  'Namena',
                'label'             =>  'Namena',
                'type'              =>  'checkbox',
                'order_category'    =>  2,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_hard_diskovi_tip',
                'name_import'       =>  'Tip',
                'label'             =>  'Tip',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_hard_diskovi_interfejs',
                'name_import'       =>  'Tip priključka ( interfejs )',
                'label'             =>  'Tip priključka ( interfejs )',
                'type'              =>  'checkbox',
                'order_category'    =>  3,
                'order_filter'      =>  3,
                'order_product'     =>  4,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_hard_diskovi_broj_obrtaja',
                'name_import'       =>  'Brzina obrtaja',
                'label'             =>  'Brzina obrtaja',
                'type'              =>  'checkbox',
                'order_category'    =>  5,
                'order_filter'      =>  5,
                'order_product'     =>  6,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_hard_diskovi_format',
                'name_import'       =>  'Veličina u inčima',
                'label'             =>  'Veličina u inčima',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
                'order_filter'      =>  6,
                'order_product'     =>  7,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_hard_diskovi_bafer',
                'name_import'       =>  'Bafer',
                'label'             =>  'Bafer',
                'type'              =>  'checkbox',
                'order_category'    =>  null,
        ...
        DB::table('Attributes')->insert(
            [
                'category_id'       =>  $category_id,
                'machine_name'      =>  'field_hard_diskovi_potrosnja',
