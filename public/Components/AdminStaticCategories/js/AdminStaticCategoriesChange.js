...
Kirby.AdminStaticCategories.Change = {
    ...
    registerElements: function(){
        Kirby.Main.Dom.register("AdminStaticCategoriesChange", this.elements);
        return this;
    },
...
//         elements.name.value = event.relatedTarget.textContent.trim();
    ...
    */
    getElement: function(element, query_all, modifier) {
        return Kirby.Main.Dom.getElement("AdminStaticCategoriesChange", element, query_all, modifier);
    },
    ...
    */
    getElementSelector: function(element, query_all, modifier) {
        return Kirby.Main.Dom.getElementSelector("AdminStaticCategoriesChange", element, query_all, modifier);
    },

    /**
     * Generise HTML na osnovu prosledjenih podataka i ubacuje u omotac
     * @param  {Object} data        podaci o kategoriji
     * @return {Object}      Kirby.AdminStaticCategories.Change objekat za ulancavanje funkcija
     */
    ...
    * @return  {Object}                    Kirby.AdminStaticCategories.Change objekat, za ulančavanje funkcija
    */
...
document.addEventListener('DOMContentLoaded', Kirby.AdminStaticCategories.Change.init.bind(Kirby.AdminStaticCategories.Change), false);
