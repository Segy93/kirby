...
Kirby.AdminStaticPages.Change = {
    ...
    elements: { // Elementi u komponenti
        ...
        input_name:   "#admin_pages__static_input__name",
        text:         "#admin_pages__static_input__text",
        page_id:      ".admin_pages__static_change__page_id",
        wrapper:      "#admin_pages__static__change",
    },
...
//     },
    ...
    */
    ...
    pageUpdated: function(data) {
          ...
          window.location.replace("/admin/staticne/strane");
    },
