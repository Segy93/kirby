(function () {
    ...
    window.Monitor.Main.Router = {
        ...
        registerElements: function() {
            Monitor.Main.DOM.register("MonitorMainRouter", elements);
        },
        ...
        getElementSelector: function(element, query_all, modifier) {
            return Monitor.Main.DOM.getElementSelector("ProductFilter", element, query_all, modifier);
        },
    };
}());
