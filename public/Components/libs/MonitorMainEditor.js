    ...
    window.Monitor.Main.Editor = {
        initEditor: function (element, selector, callback, settings = null) {
            ...
            if(settings && settings.type === "compact") {
                tinyMCE.init({
                    content_css: '/Components/libs/MonitorMainEditor.css',
                    filemanager_access_key: Monitor._params.fm_key,
                ...
                tinyMCE.init({
                    ...
                    paste_preprocess: function(plugin, args) {
                        Monitor.Main.Shortcodes.embedPaste(args);
