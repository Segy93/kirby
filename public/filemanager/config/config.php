...
$env_config =  require_once dirname(__DIR__, 3)
    . DIRECTORY_SEPARATOR
    . 'config'
    . DIRECTORY_SEPARATOR
    . php_uname('n')
    . '.php'
;
$access_key = $env_config['RESPONSIVE_FILEMANAGER'];
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => '/uploads_gallery/originals/',
    ...
    |
    */
    'current_path' => '../uploads_gallery/originals/',
    ...
    |
    */
    'thumbs_base_path' => '../uploads_gallery/thumbs/',
...
return array_merge(
    ...
    array(
        ...
        // https://developers.aviary.com/docs/web/setup-guide#constructor-config
